...
Then, let's change the labels for our regression. We do this by adding names to the list's input (lines 1--2).
...
Then, we're using `gt` output, which gives us the possibility to further style the table.
